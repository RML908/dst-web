...
import { DstMockApiReplyCallback } from '@dst/lib/mock-api/mock-api.types';

export class  DstMockApiHandler
{
    request!: HttpRequest<any>;
    urlParams!: { [key: string]: string };

    // Private
    private _reply: DstMockApiReplyCallback = undefined;
     ...
     * @param callback
     */
    reply(callback: DstMockApiReplyCallback): void
    {
        // Store the reply
