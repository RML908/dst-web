...
import { DstMockApiService, DstMockApiUtils } from '@dst/lib/mock-api';
    ...
    registerHandlers(): void
    {
        ...
        this._dstMockApiService
            ...
            .reply(({request}) => {
                ...
                // Generate a new GUID
                newList.id = DstMockApiUtils.guid();
        ...
        this._dstMockApiService
            ...
            .reply(({request}) => {
                ...
                // Generate a new GUID
                newCard.id = DstMockApiUtils.guid();
        ...
        this._dstMockApiService
            ...
            .reply(({request}) => {
                ...
                // Generate a new GUID
                newLabel.id = DstMockApiUtils.guid();
