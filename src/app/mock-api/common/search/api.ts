...
import {DstNavigationItem, DstNavigationService} from "../../../../@dst/compnents/navigation";
...
export class SearchMockApi
{
    ...
    registerHandlers(): void
    {
        ...
        const flatNavigation = this._dstNavigationService.getFlatNavigation(this._defaultNavigation);
